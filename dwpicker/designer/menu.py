...
class MenuWidget(QtWidgets.QWidget):
    ...
    copyAttrsRequested = QtCore.Signal()
    ...
    pasteAttrsRequested = QtCore.Signal()
    ...
    def __init__(self, parent=None):
        ...
        self.copyAttrs = QtWidgets.QAction(icon('copy_attrs.png'), '', self)
        self.copyAttrs.setToolTip('Copy selection Attrs')
        self.copyAttrs.triggered.connect(self.copyAttrsRequested.emit)

        self.pasteAttrs = QtWidgets.QAction(icon('paste_attrs.png'), '', self)
        self.pasteAttrs.setToolTip('Paste Attrs')
        self.pasteAttrs.triggered.connect(self.pasteAttrsRequested.emit)
        ...
        self.toolbar.addAction(self.copyAttrs)
        self.toolbar.addAction(self.pasteAttrs)
